...
function TodoItem({ todo }) {
    ...
    return (
        ...
        text-black  ${todo.completed ? "bg-[#c6e9a7]" : "bg-[#c6e9a7]"}`}
        >
            <input type="checkbox"
            ...
            justify-center items-center bg-gray-50 hover:bg-gray-100 shrink-0 disable:opacity-50'
                onClick={() => {
        ...
        <button className='inline-flex w-8 h-8 rounded-lg text-smborder border-black/10
